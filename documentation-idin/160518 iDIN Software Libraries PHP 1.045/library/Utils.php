...
class Utils {
    ...
    public static function log($message) {
        Configuration::defaultInstance()->getLogger()->log($message);
    }
    
    public static function logXmlMessage($message) {
        Configuration::defaultInstance()->getLogger()->logXmlMessage($message);
    }
